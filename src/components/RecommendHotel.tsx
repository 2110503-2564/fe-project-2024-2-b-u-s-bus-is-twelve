...
const hotels = [
    { id: 1, image: "/img/cover.jpg", name: "Luxury Hotel A", location: "Bangkok, Thailand" },
    { id: 2, image: "/img/cover2.jpg", name: "Beach Resort B", location: "Phuket, Thailand" },
    { id: 3, image: "/img/cover3.jpg", name: "Mountain Lodge C", location: "Chiang Mai, Thailand" },
    { id: 4, image: "/img/cover4.jpg", name: "City View Inn", location: "Pattaya, Thailand" },
    { id: 5, image: "/img/cover5.jpg", name: "Cozy Cabin", location: "Khao Yai, Thailand" },
    { id: 6, image: "/img/cover.jpg", name: "Skyline Suites", location: "Bangkok, Thailand" },
    { id: 7, image: "/img/cover2.jpg", name: "Seaside Escape", location: "Krabi, Thailand" },
