  ...
  return (
    <div className="flex flex-col items-center py-10 bg-gray-50">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-semibold text-gray-800">Explore Our Beautiful Gallery</h1>
        <p className="text-lg text-gray-600 mt-4">
          Dive into a collection of stunning images that capture the essence of creativity and beauty.
          Whether it's nature, architecture, or abstract art, our gallery showcases the best of visual experiences.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-10">
        ...
        <div className="relative overflow-hidden rounded-lg shadow-lg hover:scale-105 transform transition-all duration-300">
          <img src="/img/cover1.jpg" alt="Gallery Image 1" className="w-full h-64 object-cover" />
